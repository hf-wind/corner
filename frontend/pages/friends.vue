  ...
  <div class="page-layout">
    <main class="main-content">
      ...
      <div class="friends-hero">
        ...
        <a href="#" class="apply-btn" @click.prevent="showApply">申请友链</a>
      </div>

      <div v-if="loading" class="loading-tip">加载中...</div>
      <div v-else class="friends-grid">
        <a v-for="f in friends" :key="f.name" :href="f.url" target="_blank" class="friend-card">
      ...
      <div class="right-card">
        ...
        <div class="friend-stats-list">
          <div class="friend-stat-row">
            <span>友链总数</span>
            <span style="color:var(--accent);font-weight:700;">{{ friends.length }} 个</span>
          </div>
        </div>
      </div>
...
const defaultFriends = [
  { avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=128&h=128&fit=crop&crop=face', name: '林间小径', desc: '用文字描绘自然的美好，记录每一次徒步的感悟', tags: ['自然', '徒步'], url: '#' },
  { avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=128&h=128&fit=crop&crop=face', name: '数字花园', desc: '探索技术的边界，分享全栈开发的经验与思考', tags: ['技术', '全栈'], url: '#' },
  { avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=128&h=128&fit=crop&crop=face', name: '光影手记', desc: '用镜头捕捉瞬间，用光影讲述故事', tags: ['摄影', '艺术'], url: '#' },
  { avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=128&h=128&fit=crop&crop=face', name: '代码诗人', desc: '在代码中寻找诗意，在逻辑中发现美', tags: ['Rust', '编程'], url: '#' },
  { avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=128&h=128&fit=crop&crop=face', name: '书海拾贝', desc: '在书页间漫步，分享阅读的快乐与思考', tags: ['读书', '文学'], url: '#' },
  { avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=128&h=128&fit=crop&crop=face', name: '旅途笔记', desc: '世界那么大，我想去看看。记录每一次出行', tags: ['旅行', '探险'], url: '#' },
  { avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=128&h=128&fit=crop&crop=face', name: '设计手札', desc: 'UI/UX 设计师的日常，分享设计灵感与方法', tags: ['设计', 'UI/UX'], url: '#' },
  { avatar: 'https://images.unsplash.com/photo-1463453091185-61582044d556?w=128&h=128&fit=crop&crop=face', name: '深夜食堂', desc: '深夜的厨房，治愈的美食，生活的温度', tags: ['美食', '生活'], url: '#' },
  { avatar: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=128&h=128&fit=crop&crop=face', name: '音乐笔记', desc: '用音符记录心情，用旋律诉说故事', tags: ['音乐', '创作'], url: '#' },
]
...
function showApply() {
  alert('请通过邮箱 hello@corner.ink 发送友链申请。')
}
</script>
...
.friends-hero .apply-btn { display: inline-block; margin-top: 16px; padding: 8px 24px; border-radius: 20px; background: var(--c-primary); color: #fff; font-size: 0.82rem; text-decoration: none; transition: all 0.2s; box-shadow: 0 4px 12px color-mix(in srgb, var(--c-primary) 30%, transparent); }
.friends-hero .apply-btn:hover { opacity: 0.9; transform: translateY(-1px); box-shadow: 0 6px 20px color-mix(in srgb, var(--c-primary) 40%, transparent); }
...
.friend-avatar { width: 64px; height: 64px; border-radius: 50%; object-fit: cover; border: 2.5px solid var(--c-bg-1); margin-bottom: 12px; }
