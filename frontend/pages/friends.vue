  ...
  <div class="page-layout">
    ...
    <aside class="sidebar-right">
      ...
      <section class="right-card notice-card">
        ...
        <ol><li>已将本站添加到友链页</li><li>站点能够正常访问</li><li>内容健康且保持更新</li></ol>
      </section>
...
const siteLogoUrl = computed(() => {
  ...
  try { return new URL(avatar || fallback, mySite.value?.url || window.location.origin).href }
  catch { return avatar || fallback }
})
