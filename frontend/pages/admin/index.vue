...
<style scoped>
.access-identity-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.access-identity-grid>button{display:grid;min-width:0;grid-template-columns:30px minmax(0,1fr) 12px;align-items:center;gap:8px;padding:10px;border:1px solid var(--border);border-radius:8px;background:var(--c-bg-1);color:inherit;cursor:pointer;font:inherit;text-align:left;transition:border-color .18s,transform .18s}.access-identity-grid>button:hover{border-color:color-mix(in srgb,var(--c-primary) 42%,var(--border));transform:translateY(-1px)}.access-identity-icon{display:grid;width:30px;height:30px;border-radius:7px;background:var(--c-bg-2);color:var(--c-primary);place-items:center}.access-identity-icon.anonymous{color:#8490a1}.access-identity-icon.registered{color:#3e80c2}.access-identity-icon.user{color:#379768}.access-identity-grid button>span:nth-child(2){display:flex;min-width:0;flex-direction:column}.access-identity-grid small{overflow:hidden;color:var(--c-text-3);font-size:.49rem;text-overflow:ellipsis;white-space:nowrap}.access-identity-grid strong{margin-top:2px;font-size:.9rem;font-variant-numeric:tabular-nums}.access-identity-grid em{margin-top:2px;overflow:hidden;color:var(--c-text-4);font-size:.45rem;font-style:normal;text-overflow:ellipsis;white-space:nowrap}.access-identity-grid button>svg:last-child{color:var(--c-text-4);font-size:.6rem}.access-behavior-grid{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:7px;margin-top:10px;padding-top:10px;border-top:1px solid var(--border)}.access-behavior-grid>div{display:flex;min-width:0;align-items:center;gap:6px}.access-behavior-grid>div>svg{flex:0 0 auto;color:var(--c-primary);font-size:.9rem}.access-behavior-grid span{display:flex;min-width:0;flex-direction:column}.access-behavior-grid strong{font-size:.7rem;font-variant-numeric:tabular-nums}.access-behavior-grid small{color:var(--c-text-3);font-size:.46rem}
@media(max-width:1160px){.access-behavior-grid{grid-template-columns:repeat(3,1fr)}}@media(max-width:620px){.access-identity-grid{grid-template-columns:1fr}.access-behavior-grid{grid-template-columns:repeat(2,1fr)}}
</style>
