      ...
      <main class="editor-main">
        <section class="panel base-panel">
          ...
          <div class="field-grid">
            ...
            <label>主时间<a-date-picker v-model:value="albumDate" show-time class="main-date-picker" style="width:100%" /></label>
...
.main-date-picker{height:32px;box-sizing:border-box;align-self:start}.main-date-picker :deep(.ant-picker-input > input){line-height:30px}
</style>
