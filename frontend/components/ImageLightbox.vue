...
<style scoped>
.media-viewer{position:fixed;z-index:3000;inset:0;overflow:hidden;background:color-mix(in srgb,var(--c-bg) 94%,transparent);color:var(--c-text);backdrop-filter:blur(20px) saturate(.9);overscroll-behavior:none}.viewer-swiper{width:100%;height:100%}.viewer-slide{display:flex;align-items:center;justify-content:center;min-height:100%;padding:72px 92px 68px;overflow:hidden;overscroll-behavior:none}.viewer-image-wrap{display:flex;width:auto;max-width:100%;max-height:calc(100dvh - 140px);align-items:center;justify-content:center;transform-origin:center;transition:transform .25s cubic-bezier(.22,1,.36,1);will-change:transform}.viewer-image-wrap img{display:block;width:auto;max-width:calc(100vw - 184px);max-height:calc(100dvh - 140px);border-radius:6px;box-shadow:0 24px 78px rgb(0 0 0 / 28%);object-fit:contain;user-select:none;-webkit-user-drag:none}.viewer-slide.is-long{align-items:center;justify-content:center;touch-action:none}.viewer-slide.is-long .viewer-image-wrap{width:auto;max-width:100%;max-height:calc(100dvh - 140px);align-items:center}.viewer-slide.is-long img{width:auto;max-width:calc(100vw - 184px);max-height:calc(100dvh - 140px);height:auto}.viewer-video{width:min(1120px,100%);max-height:calc(100dvh - 140px);border-radius:6px;background:#000;box-shadow:0 24px 78px rgb(0 0 0 / 30%)}
